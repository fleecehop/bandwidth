	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav" id="MainTabs">
	      	...
	      	<li><a href="merch.php" style='color:black' id="merchTab">MERCH</a></li>
	        <li><a href="releases.php" style='color:black'id="releasesTab">RELEASES</a></li>
	        <li><a href="homies.php" style='color:black' id="homiesTab">HOMIES</a></li>
